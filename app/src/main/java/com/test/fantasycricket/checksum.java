...
//        setContentView(R.layout.activity_main);
        ...
        mid = "yWPSpH28181897382635"; /// your marchant key
...
// vollye , retrofit, asynch
    ...
    public class sendUserDetailTOServerdd extends AsyncTask<ArrayList<String>, Void, String> {
       ...
       // String url ="https://www.blueappsoftware.com/payment/payment_paytm/generateChecksum.php";
        String url = "http://192.168.43.46/paytm/generateChecksum.php";
        //String varifyurl = "https://pguat.paytm.com/paytmchecksum/paytmCallback.jsp";
        String varifyurl ="https://192.168.43.46/paytm/verifyChecksum.php";
        ...
        protected String doInBackground(ArrayList<String>... alldata) {
            ...
            String param=
                    "MID="+mid+
                            "&ORDER_ID=" + orderId+
                            "&CUST_ID="+custid+
                            "&CHANNEL_ID=WAP&TXN_AMOUNT=100&WEBSITE=APPSTAGING"+
